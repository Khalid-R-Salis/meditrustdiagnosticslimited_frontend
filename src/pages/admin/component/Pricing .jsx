          ...
          <tbody>
            {paginatedTests.map((test, i) => (
              <tr key={test.id} className="border-b hover:bg-gray-50 relative">
                <td className="px-5 py-3 text-black text-[10px] md:text-[12px] font-medium font-inter">
                  {(currentPage - 1) * itemsPerPage + i + 1}
                </td>
                <td className="px-5 py-3 text-[#676E76] text-[10px] md:text-[12px] font-medium font-inter">
                  {test.name}
                </td>
                <td className="px-5 py-3 text-[#676E76] text-[10px] md:text-[12px] font-medium font-inter">
                  {test.price}
                    ...
                    {menuOpen === i && (
                      ...
                      >
                        <button
                          ...
                          className="block w-full text-left px-4 py-2 hover:bg-gray-100 text-[#596066] text-[12px] md:text-[14px] font-normal font-inter"
                        >
                          Edit test
                        </button>
                        <button
