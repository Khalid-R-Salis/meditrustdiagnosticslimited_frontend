...
const Sidebar = ({ activeNav, setActiveNav, sidebarDisabled }) => {
  return (
    <div
      className={`flex flex-col justify-between bg-[#FAFAFA] rounded-[16px] border border-[#E5E7EA] w-[20rem] m-4 pt-[32px] px-[12px] mx-[16px] min-h-[calc(100vh-2rem)] relative transition-opacity duration-200 ${
