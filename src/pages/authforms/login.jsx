  ...
  return (
    <>
      ...
      <form
        ...
        className="relative min-h-screen flex flex-col bg-[#f9f9f9]"
      >
        <div className="flex flex-col items-center gap-[8px] w-full">
          <div
            className="sticky top-0 left-0 w-full flex items-center bg-white z-10"
            style={{
          ...
          {/* Login Box */}
          <div className="flex-1 overflow-y-auto flex flex-col items-center justify-center px-4 py-6 sm:py-10 gap-4">
              ...
              <div className="mb-[32px]">
                ...
                <p className="text-[#383F45] text-[14px] leading-[20px] font-normal font-[inter] mt-1">
                  <span className="block sm:hidden">
                    Sign in with your assigned credentials to access the
                    MediTrust Admin Dashboard.
                  </span>
            ...
            <div className="md:sm:hidden w-[90%] max-w-[440px] flex justify-center items-center px-[10px] pb-[10px] pt-0 text-center mx-auto">
