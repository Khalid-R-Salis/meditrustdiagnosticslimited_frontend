...
const ContactAdmin = () => {
  ...
  return (
    ...
    >
      ...
      {/* Scrollable content wrapper with spacing below header */}
      <div className="flex-1 overflow-y-auto flex items-center justify-center px-4 py-6 sm:py-10">
        <div className="bg-[#FFF] p-[24px] sm:p-[40px] rounded-[24px] shadow-md w-full sm:w-[440px] max-w-[440px]">
          {/* Success message */}
          {messageSent && (
          ...
          <p className="text-[#383F45] text-[13px] sm:text-[14px] leading-[20px] font-normal font-inter mb-6">
            Kindly fill the form below and your complaint will be sent directly
